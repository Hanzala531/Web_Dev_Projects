...
async function DisplayAlbums() {
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    if (e.href.includes("/AudioFiles")) {
      ...
      let a = await fetch(
        `http://127.0.0.1:3000/AudioFiles/${folder}/info.json`
      );
      ...
      cardContainer.innerHTML =
        ...
        `<div class="card" data-folder="${response.data}">
            ...
            <img
              src="http://127.0.0.1:3000/AudioFiles/${folder}/cover.jpeg"
  ...
  for (let i = 0; i < array.length; i++) {
    ...
    if (e.href.includes("/AudioFiles")) {
      ...
      cardContainer.innerHTML += `<div class="card" data-folder="${response.data}">
            <div class="play-button">▶</div>
            <img src="./AudioFiles/${folder}/cover.jpeg" alt="recitation-without-translation" />
            <h2>${response.tittle}</h2>
            <span>${response.description}</span>
          </div>`;
    }
